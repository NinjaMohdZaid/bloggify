...
if(!isset($_SESSION['loggedIn']))
{
    header('Location:../');
              ...
              $sql="SELECT * FROM `blogs` WHERE isRecycle='no' AND sno='$sno'";
...
<head>
    ...
    <link rel="stylesheet" href="../cssFiles/readBlogsOtherAll.css">
     ...
     <nav>
      ...
      <div id="area1">
            <?php
               ...
               $views=$row['views']+1;//increase view
               $sqlU="UPDATE `blogs` SET views='$views' WHERE sno='$sno'";
               $resultU=mysqli_query($connect,$sqlU);
             ?>
             </div>
             <div id="area2">
              <h4>Comments</h4>
              <form action="../partials/commentByAll.php?sno=<?php echo $row['sno'];   ?>" method="post">
